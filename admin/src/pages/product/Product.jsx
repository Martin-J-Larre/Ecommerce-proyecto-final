      ...
      <div className="productBottom">
        <div className="productForm">
          <div className="productFormLeft">
            ...
            <Duo>
            <Input  placeholder={produc.title} name="title" type="text" onChange={(e) => setName(e.target.value)}/>
            </Duo>
            <Duo>
            <Input  placeholder={produc.desc} name="desc" type="text" onChange={(e) => setDesc(e.target.value)}/>
            </Duo>
            <Duo>
            <Input  placeholder={produc.price} name="price" type="number" onChange={(e) => setPrice(e.target.value)} />
            </Duo>
            <Duo>
            ...
            <Duo>
            <Input type="text" placeholder={produc.color}  onChange={(e) => setColor(e.target.value)} />
            </Duo>
            <Duo>
            <Input type="text" placeholder={produc.size}  onChange={(e) => setSize(e.target.value)} />
            </Duo>
            <Duo>
